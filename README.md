...
[![codecov](https://codecov.io/gh/tony-gm/fastapi-project-template/branch/main/graph/badge.svg?token=fastapi-project-template_token_here)](https://codecov.io/gh/tony-gm/fastapi-project-template)
[![CI](https://github.com/tony-gm/fastapi-project-template/actions/workflows/main.yml/badge.svg)](https://github.com/tony-gm/fastapi-project-template/actions/workflows/main.yml)

Awesome fastapi_project_template created by tony-gm

## Install

from source
```bash
git clone https://github.com/tony-gm/fastapi-project-template fastapi_project_template
